<?php
    ...
    if(mysqli_connect_error())
	{
		...
		$sql="update stock
set NUMBER_OF_STOCKS = NUMBER_OF_STOCKS -(select sum(t1.qty)
from sale as t1
				...
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(ex2.jpeg)">
						<div class="banner_category">
							<a href="display_stock.php">STOCKS IN THE STORE</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(ex2.jpeg)">
						<div class="banner_category">
							<a href="display_restock.php">RESTOCK TABLE</a>
						</div>
					</div>
				</div>
				<div class="col-md-4">
					<div class="banner_item align-items-center" style="background-image:url(adp.png)">
						<div class="banner_category">
							<a href="form_stock.html">ADD STOCK</a>
						</div>
					</div>
				</div>
			</div>
